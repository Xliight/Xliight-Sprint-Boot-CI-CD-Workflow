                    ...
                    <table width="648" border="0" cellspacing="0" cellpadding="0" bgcolor="#656565">
                        ...
                        <tr>
                            <td align="center"
                                ...
                                <font style="font-size:18px;font-family:Arial,sans-serif;font-weight:lighter;line-height:24px" color="#ffffff">Code de validation TicTacSanté </font>
                            </td>
                        </tr>
                        </tbody>
                    </table>
                    <div style="padding:10px 15px 10px;color:#5f5f5f;font-family:sans-serif;font-weight:100;line-height:21px;font-size:15px">
                        <table cellpadding="12" cellspacing="0" border="0" width="100%" style="font-family:Helvetica,Arial,sans-serif;width:100%!important">
                            ...
                            <tr>
                                <td>
                                    ...
                                    <p style="text-align: justify;">
                                        Nous avons reçu une demande de changement d'adresse e-mail pour votre compte TicTacSanté.
                                    </p>
                                    <p style="text-align: justify;">
                                        Nous vous prions de bien vouloir confirmer votre nouvelle adresse e-mail (${email}) afin qu’elle soit prise en compte.
                                    </p>
                                    <p style="text-align: justify;">
                                       Votre code de validation TicTacSanté est :
                                    </p>
                                </td>
                            </tr>
                            <tr>
                                <td width="auto" align="left">
                                    <table border="0" cellpadding="0" cellspacing="0" align="center">
                                        <tbody><tr>
                                            <td width="auto" align="center" height="37" style="border-top-left-radius: 20px; border-top-right-radius: 20px; border-bottom-right-radius: 20px; border-bottom-left-radius: 20px; padding-left: 22px; padding-right: 22px;font-size: 26px ;font-weight: bold; font-family: Helvetica, Arial, sans-serif, 'Open Sans'; color: #2d2d2d; font-weight: 600;">
                                                ${code}
                                            </td>
                                        </tr>
                                        </tbody>
                            ...
                            <tr>
                                <td>
                                    <h1 style="margin:0;padding:0;font-family:Helvetica,Arial,sans-serif;color:#555555;font-size:16px">
                                        Si vous n'avez pas demandé à recevoir ce code, il est possible qu'un tiers essaie à accéder à votre compte TicTacSanté. <b>Ne transférez ce code à aucune autre personne.</b>
                                    </h1>
                                    <p style="text-align: justify;">
                                        Cordialement,
                                    </p>
                                    <p style="text-align: justify;">
                                        L'équipe TicTacSanté
                                    </p>
                                </td>
                            </tr>
                            </tbody>
