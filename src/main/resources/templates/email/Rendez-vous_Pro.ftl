        ...
        <div style="padding-top:10px;padding-bottom:10px;margin:0;background:#fff">
            <div style="max-width:650px;margin:30px auto">
                <div style="border:1px solid #e8e8e8;padding:20px 0 0;background:#fff">
                    ...
                    <table width="648" border="0" cellspacing="0" cellpadding="0" bgcolor="#656565">
                        ...
                        <tr>
                            <td align="center"
                                ...
                                <font style="font-size:18px;font-family:Arial,sans-serif;font-weight:lighter;line-height:24px" color="#ffffff">Nouvelle réservation de {{ ShortNom }}</font>
                            </td>
                        </tr>
                        </tbody>
                    </table>
                            ...
                            <tr>
                                <td>
                                    ...
                                    <p style="text-align: justify;">
                                        {#{ NomComplet_Patient }#} vient de faire une demande de réservation suivant :
                                    </p>
                                </td>
                            </tr>
                                                ...
                                                <table cellpadding="0" cellspacing="0" border="0" width="100%" bgcolor="white">
                                                    ...
                                                    <tr>
                                                        <td width="84" align="left" valign="top">
                                                            <a href="#" style="font-family:Helvetica,Arial,sans-serif;color:#3ab2fa" target="_blank" data-saferedirecturl="#">
                                                                <img src="https://x1.xingassets.com/assets/frontend_minified/img/users/nobody_m.original.jpg" width="72" height="72" style="width:72px;min-height:72px" class="CToWUd">
                                                            </a>
                                                        </td>
                                                        <td>
                                                                        ...
                                                                        <table width="49%" align="left" cellspacing="0" cellpadding="0">
                                                                            ...
                                                                            <tr>
                                                                                <td align="left" valign="top">
                                                                                    <a href="#">
                                                                                        <p style="margin:0;padding:0;color:#666666;font-size:17px;line-height:1.4em;font-family:Helvetica,Arial,sans-serif">
                                                                                            <a href="#"
                                                                                               style="font-family:Helvetica,Arial,sans-serif;color:#0086bf;text-decoration:none"
                                                                                               target="_blank">
                                                                                                <strong>{{ ShortNom }}</strong>
                                                                                            </a>
                                                                                            {% if Age %}
                                                                                                - {{ Age }} ans
                                                                                            {% endif %}
                                                                                    ...
                                                                                    <p style="margin:0;padding:0;font-family:Helvetica,Arial,sans-serif;line-height:1.4em;color:#555555">
                                                                                        {{ AdressePatient }}
                                                                                        <br>
                                                                                        <strong>{{ VillePatient }}, {{ PaysPatient }}</strong>
                                                                                    </p>
                                                                                </td>
                                                                            </tr>
                                                                            </tbody>
                                                                            ...
                                                                            <tr>
                                                                                <td align="right" valign="top">
                                                                                    ...
                                                                                    <strong style="font-family:Helvetica,Arial,sans-serif;color:#555555">
                                                                                        <a href="tel:06%2081%2011%2045%2093" value="+33681114593" target="_blank">{{ GSMPatient }}</a></strong>
                                                                                    <table width="100%" cellpadding="0" cellspacing="0" border="0">
                                                                                        <tbody>
                                                                                        <tr>
                                                                                            <td height="6"></td>
                    ...
                    <div style="padding:0px 15px 10px;color:#5f5f5f;font-family:sans-serif;font-weight:100;line-height:21px;font-size:15px">
                        <table cellpadding="12" cellspacing="0" border="0" width="100%" style="font-family:Helvetica,Arial,sans-serif;width:100%!important">
                            <tbody>
                            <tr>
                                <td>
                                                            ...
                                                            <table border="0" cellpadding="0" cellspacing="0" style="font-family:arial,helvetica,sans-serif;background:#0086bf;border-radius:3px;border-collapse:separate;border:1px solid #0086bf;width:60%">
                                                                ...
                                                                <tr>
                                                                    <td align="center" valign="middle" style="font-size:160%">
                                                                        <a href="https://pro.tictacSante.com" style="display:block;padding:10px;color:#ffffff;text-decoration:none" target="_blank">
                                                                            Mon espace pro
                                                                        </a>
                                                                    </td>
                                                                </tr>
