...
<head>
    <meta charset="UTF-8">
    <title>Confirmation de votre demande de changement d'information</title>
</head>
<body>
        ...
        <div style="padding-top:10px;padding-bottom:10px;margin:0;background:#fff">
            <div style="max-width:650px;margin:30px auto">
                <div style="border:1px solid #e8e8e8;padding:20px 0 0;background:#fff">
                    ...
                    <table width="648" border="0" cellspacing="0" cellpadding="0" bgcolor="#656565">
                        ...
                        <tr>
                            <td align="center"
                                ...
                                <font style="font-size:18px;font-family:Arial,sans-serif;font-weight:lighter;line-height:24px" color="#ffffff">Confirmation de votre demande de changement d'information</font>
                            </td>
                        </tr>
                        </tbody>
                    </table>
                    <div style="padding:10px 15px 0;color:#5f5f5f;font-family:sans-serif;font-weight:100;line-height:21px;font-size:15px">
                            ...
                            <tr>
                                <td style="padding-bottom:0;">
                                    ...
                                    <p style="text-align: justify;    margin-bottom: 0;">
                                        Nous avons le plaisir de vous informer que votre demande de changement d'information a été effectuée.
                                    </p>
                                </td>
                            </tr>
                            </tbody>
                    ...
                    <div style="    padding: 0 25px 10px;color:#5f5f5f;font-family:sans-serif;font-weight:100;line-height:21px;font-size:15px">
                        <p>
                                            ...
                                            <table cellpadding="0" cellspacing="0" style="width:100%">
                                                ...
                                                <tr>
                                                    <td style="padding-bottom:3px;background-color:#444444;color:#fff" align="center">
                                                        <a href="#" style="color:#fff;font-family:Arial,Helvetica,sans-serif,'Roboto';font-size:10px;text-decoration:none" target="_blank">
                                                            CGU
                                                        </a>
                                                        &nbsp;&nbsp;|&nbsp;&nbsp;
                                                        <a href="#" style="color:#fff;font-family:Arial,Helvetica,sans-serif,'Roboto';font-size:10px;text-decoration:none" target="_blank">
