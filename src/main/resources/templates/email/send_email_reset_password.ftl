                    ...
                    <table width="648" border="0" cellspacing="0" cellpadding="0" bgcolor="#656565">
                        ...
                        <tr>
                            <td align="center"
                                ...
                                <font style="font-size:18px;font-family:Arial,sans-serif;font-weight:lighter;line-height:24px" color="#ffffff">Réinitialisation du mot de passe </font>
                            </td>
                        </tr>
                        </tbody>
                    </table>
                            ...
                            <tr>
                                <td style="padding-bottom: 0;">
                                    ...
                                    <p style="text-align: justify;">
                                        Votre mot de passe a été bien rénitialisé.
                                    </p>
                                </td>
                            </tr>
