                        ...
                        <table cellpadding="12" cellspacing="0" border="0" width="100%" style="font-family:Helvetica,Arial,sans-serif;width:100%!important">
                            ...
                            <tr>
                                <td>
                                    <h1 style="margin:0;padding:0;font-family:Helvetica,Arial,sans-serif;color:#555555;font-size:16px">
                                        Bonjour ${prenom?cap_first} ${nom?upper},
                                    </h1>
                                    <p style="text-align: justify;">
                                        Votre compte TicTacSanté est maintenant configuré et vous pouvez désormais accéder à votre espace patient
                            ...
                            <tr>
                                <td valign="middle" width="100%" style="text-align: left; font-family: Helvetica, Arial, sans-serif, 'Open Sans'; font-size: 14px; color: #333333; line-height: 22px; font-weight: 400;text-align: justify;">
                                    Si vous avez oublié votre mot de passe, cliquez sur le lien suivant et suivez les instructions : <a href="${path('Web_mot_passe_oublie')}">Réinitialiser mon mot de passe.</a>
