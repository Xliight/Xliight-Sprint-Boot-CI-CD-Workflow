                    ...
                    <table width="648" border="0" cellspacing="0" cellpadding="0" bgcolor="#656565">
                        ...
                        <tr>
                            <td align="center"
                                ...
                                <font style="font-size:18px;font-family:Arial,sans-serif;font-weight:lighter;line-height:24px" color="#ffffff">Suite à votre demande de service TicTacSanté</font>
                            </td>
                        </tr>
                        </tbody>
                    </table>
                            ...
                            <tr>
                                <div>
                                    ...
                                    <p style="text-align: justify;">
                                        Merci de votre intérêt pour TicTacSanté.
                                    </p>
                                    <p style="text-align: justify;">
                                        Enfin le lancement de TicTacSanté au MAROC : Une plateforme, leader N° 1, dédiée autant qu'aux médecins  (comme vous ou de toutes spécialités) qu'aux patients, dont la prise de rendez-vous en fait le noyau!
                                    </p>
                                    <p style="text-align: justify;">
                                        Tarifs : toutes ces opérations sont offertes et gratuitement pendant 6 mois sans engagements et sans aucun frais caché, merci de remplir et de nous retourner le formulaire ci joint afin que nous puissions traiter votre demande de service TicTacSanté.
                                    </p>
                                    <p style="text-align: justify;">
                                        Nous vous confirmons que nous avons bien reçu votre demande.Nous vous informons que votre demande sera traité soigneusement dans les plus brefs délais.
                                    </p>
                                    <p style="text-align: justify;">
                                        Bien que nous essayons d'examiner en détail toutes les demandes, il nous est parfois impossible de répondre dans un délai raisonnable.
                                    </p>
                                    <p>
                                        Le monde devient numérique ! Devenons-le avec lui !
                                    </p>
                                    <p style="text-align: justify;">
                                        Dans cette attente, nous vous prions d'agréer l'expression de nos sentiments distingués.
                                    </p>
                                    <p>
                                        L'Equipe TicTacSanté
                                    </p>
                                </div>
                                                                    ...
                                                                    <table border="0" cellpadding="0" cellspacing="0" width="100%" style="background-color:#2085c6;color:#fff">
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <td align="right" valign="middle" style="">
                                                                                ...
                                                                                <div style="width:140px;text-align:left;font-size:15px;background:url(https://cdn.tictacsante.com/assets_mail/_elements/iconsupport.png) center left no-repeat;padding-left:45px;display:inline-block;font-family:sans-serif;font-weight:100;line-height:21px;">
