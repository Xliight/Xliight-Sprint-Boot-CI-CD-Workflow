...
<head>
    <meta charset="UTF-8">
    <title>Code de validation de changement de mot de passe</title>
</head>
<body>
        ...
        <div style="padding-top:10px;padding-bottom:10px;margin:0;background:#fff">
            <div style="max-width:650px;margin:30px auto">
                <div style="border:1px solid #e8e8e8;padding:20px 0 0;background:#fff">
                    ...
                    <table width="648" border="0" cellspacing="0" cellpadding="0" bgcolor="#656565">
                        ...
                        <tr>
                            <td align="center"
                                ...
                                <font style="font-size:18px;font-family:Arial,sans-serif;font-weight:lighter;line-height:24px" color="#ffffff">Code de validation</font>
                            </td>
                        </tr>
                        </tbody>
                    </table>
                    <div style="padding:10px 15px 10px;color:#5f5f5f;font-family:sans-serif;font-weight:100;line-height:21px;font-size:15px">
                        <table cellpadding="12" cellspacing="0" border="0" width="100%" style="font-family:Helvetica,Arial,sans-serif;width:100%!important">
                            ...
                            <tr>
                                <td style="padding-bottom: 0;">
                                    ...
                                    <p style="text-align: justify;">
                                        Vous avez demandé la réinitialisation de votre mot de passe. Afin de modifier votre mot de passe, veuillez saisir le code ci-dessous sur l'accès OuiTrips :
                                    </p>
                                </td>
                            </tr>
                            <tr>
                                <td width="auto" align="left" style="padding-top: 0;">
                                    <table border="0" cellpadding="0" cellspacing="0" align="center">
                                        <tbody><tr>
                                            <td width="auto" align="center" height="30" bgcolor="#52a54d" style="border-top-left-radius: 20px; border-top-right-radius: 20px; border-bottom-right-radius: 20px; border-bottom-left-radius: 20px; padding-left: 22px; padding-right: 22px; font-weight: bold; font-family: Helvetica, Arial, sans-serif, 'Open Sans'; color: #ffffff; font-weight: 600;">
                                                <a style="color: #ffffff; font-size: 14px; text-decoration: none; line-height: 34px; width: 100%;">${code}</a>
                                            </td>
                                        </tr>
                                        </tbody>
                                    </table>
                            ...
                            <tr>
                                <td valign="middle" width="100%" style="padding-top: 0px;padding-bottom: 0px; text-align: left; font-family: Helvetica, Arial, sans-serif, 'Open Sans'; font-size: 14px; color: #333333; line-height: 22px; font-weight: 400;text-align: justify;">
                                    Ce code de validation expire dans un délai de 2 heures, assurez-vous de l’utiliser à temps.
                                </td>
                            </tr>
                            <tr>
                                <td valign="middle" width="100%" style="padding-top: 0px;padding-bottom: 0px; text-align: left; font-family: Helvetica, Arial, sans-serif, 'Open Sans'; font-size: 14px; color: #333333; line-height: 22px; font-weight: 400;text-align: justify;">
                                    <p>
                                        Pour des raisons de sécurité, ce code n’est valide qu'une seule fois. Le cas échéant, vous avez la possibilité de refaire une nouvelle demande de réinitialisation de mot de passe OuiTrips vous envoie un nouveau code pour changer votre mot de passe en cliquant sur « Mot de passe oublié ? » directement depuis le formulaire de connexion.
                                    </p>
                                </td>
                            </tr>
                            <tr>
                                <td valign="middle" width="100%" style="padding-top: 0px;padding-bottom: 0px; text-align: left; font-family: Helvetica, Arial, sans-serif, 'Open Sans'; font-size: 14px; color: #333333; line-height: 22px; font-weight: 400;text-align: justify;">
                                    <p> Si vous n’êtes pas à l’origine de cette demande, merci de ne pas prendre en compte cet email.</p>
                                                                        ...
                                                                        <table align="center" border="0" cellpadding="0" cellspacing="0" style="padding:0 0 0 6px;text-align:center;width:100%">
                                                                            ...
                                                                            <tr>
                                                                                <td style="display:inline-block;padding:0 4px;text-align:center">
                                                                                    <a href="https://twitter.com/ouitrips" style="text-decoration:none" target="_blank">
                                                                                        <img src="https://cdn.tictacsante.com/assets_mail/icons/twitter-icon-mobile.png" alt="Twitter" border="0" width="30" height="30">
                                                                                    </a>
                                                                                </td>
                                                                                <td style="display:inline-block;padding:0 4px;text-align:center">
                                                                                    <a href="https://www.facebook.com/ouitrips" style="text-decoration:none" target="_blank">
                                                                                        <img src="https://cdn.tictacsante.com/assets_mail/icons/facebook-icon-mobile.png" alt="Facebook" border="0" width="30" height="30">
                                                                                    </a>
                                                                                </td>
                                                                                <td style="display:inline-block;padding:0 4px;text-align:center">
                                                                                    <a href="https://www.instagram.com/ouitrips" style="text-decoration:none" target="_blank">
                                                                                ...
                                                                                <td style="display:inline-block;padding:0 4px;text-align:center">
                                                                                    <a href="https://www.linkedin.com/company/ouitrips/" style="text-decoration:none" target="_blank">
                                                                        ...
                                                                        <table border="0" cellpadding="0" cellspacing="0" style="width:100%">
                                                                            ...
                                                                            <tr>
                                                                                <td style="display:inline-block;padding:0 3px">
                                                                                    <a href="https://ouitrips.com" target="_blank" >
                                                                                ...
                                                                                <td style="display:inline-block;padding:0 3px">
                                                                                    <a href="https://ouitrips.com" style="text-decoration:none" target="_blank">
                                            ...
                                            <table cellpadding="0" cellspacing="0" style="width:100%">
                                                        ...
                                                        <table border="0" cellpadding="0" cellspacing="0" width="100%" style="background-color:#2085c6;color:#fff">
                                                            ...
                                                            <tr>
                                                                <td valign="middle" style="padding:16px">
                                                                    <a href="https://www.ouitrips.com" style="color:#ffffff" target="_blank">
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <td align="right" valign="middle" style="">
                                                                                ...
                                                                                <div style="width:130px;text-align:left;font-size:15px;background:url(https://cdn.tictacsante.com/assets_mail/_elements/iconsupport.png) center left no-repeat;padding-left:45px;display:inline-block;font-family:sans-serif;font-weight:100;line-height:21px;">
                                                                                    ...
                                                                                    <a style="color:#fff;font-size:13px" href="mailto:infos@ouitrips.com" target="_blank">infos@tictacsante.com</a>
                                                                                </div>
                                                                            </td>
                                                                        </tr>
                                                                        </tbody>
                                                ...
                                                <tr>
                                                    <td style="padding-bottom:3px;background-color:#444444;color:#fff" align="center">
                                                        <a href="https://ouitrips.com/conditions-generales-utilisation" style="color:#fff;font-family:Arial,Helvetica,sans-serif,'Roboto';font-size:10px;text-decoration:none" target="_blank">
                                                            CGU
                                                        </a>
                                                        &nbsp;&nbsp;|&nbsp;&nbsp;
                                                        <a href="https://ouitrips.com/politique-confidentialite" style="color:#fff;font-family:Arial,Helvetica,sans-serif,'Roboto';font-size:10px;text-decoration:none" target="_blank">
                                                            Politique de confidentialité
                                                        </a>
                                                        &nbsp;&nbsp;|&nbsp;&nbsp;<a href="ouitrips.com/contact" style="color:#fff;font-family:Arial,Helvetica,sans-serif,'Roboto';font-size:10px;text-decoration:none" target="_blank">
                                                            Nous contacter</a>
                                                        &nbsp;&nbsp;|&nbsp;&nbsp;
                                                        <a href="ouitrips.com/se-desabonner" style="color:#fff;font-family:Arial,Helvetica,sans-serif,'Roboto';font-size:10px;text-decoration:none" target="_blank">
                                                            Se désinscrire
                                                        </a>
                                                    </td>
                ...
                <p style="margin:0;margin-top:20px;text-align:center;font-family:sans-serif;color:#5f5f5f;font-size:13px;font-weight:100">
                    OuiTrips © ${year} - Tous droits réservés.
                </p>
            </div>
        </div>
    </div>
