...
<head>
    <meta charset="UTF-8">
    <title>
        Bienvenue sur TicTacSanté</title>
</head>
<body>
                    ...
                    <table width="648" border="0" cellspacing="0" cellpadding="0" bgcolor="#656565">
                        ...
                        <tr>
                            <td align="center"
                                ...
                                <font style="font-size:18px;font-family:Arial,sans-serif;font-weight:lighter;line-height:24px" color="#ffffff">Bienvenue sur TicTacSanté</font>
                            </td>
                        </tr>
                        </tbody>
                    </table>
                        ...
                        <table cellpadding="12" cellspacing="0" border="0" width="100%" style="font-family:Helvetica,Arial,sans-serif;width:100%!important">
                            ...
                            <tr>
                                <td>
                                    ...
                                    <p style="text-align: justify;">
                                        Votre compte TicTacSanté est désormais créé, vous pouvez accéder à votre espace patient en cliquant sur le bouton suivant :
                                    </p>
                                </td>
                            </tr>
                            ...
                            <tr>
                                <td width="auto" align="left">
                                    <table border="0" cellpadding="0" cellspacing="0" align="center">
                                        <tr>
                                            <td width="auto" align="center" height="37" bgcolor="#2d9697" style="border-top-left-radius: 20px; border-top-right-radius: 20px; border-bottom-right-radius: 20px; border-bottom-left-radius: 20px; padding-left: 22px; padding-right: 22px; font-weight: bold; font-family: Helvetica, Arial, sans-serif, 'Open Sans'; color: #ffffff; font-weight: 600;">
                                                <a href="https://www.tictacsante.com" style="color: #ffffff; font-size: 14px; text-decoration: none; line-height: 34px; width: 100%;">C'est parti </a>
                                            </td>
                                        </tr>
                                    </table>
                                </td>
                            ...
                            <tr>
                                <td valign="middle" width="100%" style="text-align: left; font-family: Helvetica, Arial, sans-serif, 'Open Sans'; font-size: 14px; color: #333333; line-height: 22px; font-weight: 400;text-align: justify;">
                                    Mot de passe oublié ? Cliquez sur le lien suivant et suivez les instructions :  <a href="${url}">Réinitialiser mon mot de passe</a>
                                </td>
                            </tr>
                            </tbody>
                        </table>
                                                                ...
                                                                <td align="right" valign="middle" style="color:#fff;font-size:10px; ">
                                                                    ...
                                                                    <table border="0" cellpadding="0" cellspacing="0" width="100%" style="background-color:#2085c6;color:#fff">
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <td align="right" valign="middle" style="margin-right: 5px;">

                                                                                <div style="width:130px;text-align:left;margin-right:10px;font-size:15px;background:url(https://cdn.tictacsante.com/assets_mail/_elements/iconsupport.png) center left no-repeat;padding-left:45px;display:inline-block;font-family:sans-serif;font-weight:100;line-height:21px;">
