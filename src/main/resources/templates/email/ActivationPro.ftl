                    ...
                    <table width="648" border="0" cellspacing="0" cellpadding="0" bgcolor="#656565">
                        ...
                        <tr>
                            <td align="center"
                                ...
                                <font style="font-size:18px;font-family:Arial,sans-serif;font-weight:lighter;line-height:24px" color="#ffffff">Confirmation d'inscription</font>
                            </td>
                        </tr>
                        </tbody>
                    </table>
                            ...
                            <tr>
                                <td>
                                    ...
                                    <p style="text-align: justify;">
                                        Vous venez de vous créer un compte sur le site www.tictacsante.com et nous vous en remercions !
                                    </p>
                                    <p style="text-align: justify;">
                                        Pour vous connecter, votre identifiant est ${email}
                                        Conservez précieusement le mot de passe que vous avez choisi ; il vous sera demandé à chaque connexion.
                                    </p>
                                    <p style="text-align: justify;">
