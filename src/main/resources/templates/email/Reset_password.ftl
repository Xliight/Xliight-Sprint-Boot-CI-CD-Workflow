                    ...
                    <table width="648" border="0" cellspacing="0" cellpadding="0" bgcolor="#656565">
                        ...
                        <tr>
                            <td align="center"
                                ...
                                <font style="font-size:18px;font-family:Arial,sans-serif;font-weight:lighter;line-height:24px" color="#ffffff">Réinitialiser votre mot de passe</font>
                            </td>
                        </tr>
                        </tbody>
                    </table>
                    <div style="padding:10px 15px 10px;color:#5f5f5f;font-family:sans-serif;font-weight:100;line-height:21px;font-size:15px">
                        <table cellpadding="12" cellspacing="0" border="0" width="100%" style="font-family:Helvetica,Arial,sans-serif;width:100%!important">
                            ...
                            <tr>
                                <td>
                                    ...
                                    <p style="text-align: justify;">
                                        Vous avez demandé la réinitialisation de votre mot de passe. Afin de modifier votre mot de passe, nous vous invitons à cliquer sur le bouton suivant :
                                    </p>
                                </td>
                            </tr>
                            <tr>
                                <td width="auto" align="left">
                                    ...
                                    <table border="0" cellpadding="0" cellspacing="0" align="center">
                                        <tbody><tr>
                                            <td width="auto" align="center" height="37" bgcolor="#52a54d" style="border-top-left-radius: 20px; border-top-right-radius: 20px; border-bottom-right-radius: 20px; border-bottom-left-radius: 20px; padding-left: 22px; padding-right: 22px; font-weight: bold; font-family: Helvetica, Arial, sans-serif, 'Open Sans'; color: #ffffff; font-weight: 600;">
                                                <a href="${url}" style="color: #ffffff; font-size: 14px; text-decoration: none; line-height: 34px; width: 100%;">Définir un nouveau mot de passe</a>
                                            </td>
                                        </tr>
                                        </tbody></table>
                            ...
                            <tr>
                                ...
                                Si cela ne fonctionne pas, coller le lien suivant dans votre navigateur  :<br>
                                ${url}
                                </td>
                            </tr>
                            <tr>
                                <td valign="middle" width="100%" style="padding-top: 0px;padding-bottom: 0px; text-align: left; font-family: Helvetica, Arial, sans-serif, 'Open Sans'; font-size: 14px; color: #333333; line-height: 22px; font-weight: 400;text-align: justify;">
                                    Ce lien expire dans un délai de 2 heures, assurez-vous de l’utiliser à temps.
                                </td>
                            </tr>
                            <tr>
                                <td valign="middle" width="100%" style="padding-top: 0px;padding-bottom: 0px; text-align: left; font-family: Helvetica, Arial, sans-serif, 'Open Sans'; font-size: 14px; color: #333333; line-height: 22px; font-weight: 400;text-align: justify;">
                                    <p>
                                        Pour des raisons de sécurité, ce lien n’est valide qu'une seule fois. Le cas échéant, vous avez la possibilité de refaire une nouvelle demande de réinitialisation de mot de passe, TicTacSanté vous envoie un nouveau lien pour changer votre mot de passe en cliquant sur « Mot de passe oublié ? » directement sur le formulaire de connexion.
                                    </p>
                                </td>
                            </tr>
                            <tr>
