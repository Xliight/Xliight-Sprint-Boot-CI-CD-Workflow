                    ...
                    <table width="648" border="0" cellspacing="0" cellpadding="0" bgcolor="#656565">
                        ...
                        <tr>
                            <td align="center"
                                ...
                                <font style="font-size:18px;font-family:Arial,sans-serif;font-weight:lighter;line-height:24px" color="#ffffff">${title}</font>
                            </td>
                        </tr>
                        </tbody>
                    </table>
                            ...
                            <tr>
                                <td>
                                    ...
                                    <p style="text-align: justify;">
                                        <#if statut == 'valider'>
                                            Nous avons le plaisir de vous informer que le patient ${PatientName} vous a laissé un avis.
                                        <#elseif statut == 'annuler'>
                                            Nous avons le plaisir de vous informer que le praticien ${PatientName} a laissé un commentaire.
                                        <#elseif statut == 'accepter'>
                                            Nous avons le plaisir de vous informer que votre avis a été publié.
                                        <#else>
                                            Nous avons le plaisir de vous informer que votre avis a bien été reçu et nous allons la mettre
                                            en ligne dès qu'elle sera validée par notre équipe.
                                        </#if>

                                    </p>
                                    <h4 style="margin:0;padding:0;font-family:Helvetica,Arial,sans-serif;color:#555555;font-size:16px">Commentaire</h4>
                                    ...
                                    <table border="0" cellpadding="0" cellspacing="0" align="center">
                                        <tbody><tr>
                                            <td width="auto" align="center" height="37" bgcolor="#52a54d" style="border-top-left-radius: 20px; border-top-right-radius: 20px; border-bottom-right-radius: 20px; border-bottom-left-radius: 20px; padding-left: 22px; padding-right: 22px; font-weight: bold; font-family: Helvetica, Arial, sans-serif, 'Open Sans'; color: #ffffff; font-weight: 600;">
                                                <a href="${url}" style="color: #ffffff; font-size: 14px; text-decoration: none; line-height: 34px; width: 100%;">Avis</a>
                                            </td>
                                        </tr>
                                        </tbody></table>
