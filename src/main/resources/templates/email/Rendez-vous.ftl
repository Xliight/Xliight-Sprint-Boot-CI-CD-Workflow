        ...
        <div style="padding-top:10px;padding-bottom:10px;margin:0;background:#fff">
            <div style="max-width:650px;margin:30px auto">
                    ...
                    <table width="648" border="0" cellspacing="0" cellpadding="0" bgcolor="#656565">
                        ...
                        <tr>
                            <td align="center"
                                ...
                                <font style="font-size:18px;font-family:Arial,sans-serif;font-weight:lighter;line-height:24px" color="#ffffff">Confirmation de Rendez-vous</font>
                            </td>
                        </tr>
                        </tbody>
                    </table>
                            ...
                            <tr>
                                <td>
                                    ...
                                    <p style="text-align: justify;">
                                        Nous vous confirmons la réservation de votre rendez-vous
                                    </p>
                                </td>
                            </tr>

                            <tr>
                                <td valign="middle" width="100%" style="text-align: left; font-family: Helvetica, Arial, sans-serif, 'Open Sans'; font-size: 14px; color: #333333; line-height: 22px; font-weight: 400;text-align: justify;">

                                    <table cellpadding="12" cellspacing="0" border="0" bgcolor="#ffffff" width="100%" style="background-color:#ffffff;font-family:Helvetica,Arial,sans-serif;width:100%!important">
                                        <tbody>
                                        ...
                                        <tr>
                                            <td>
                                                ...
                                                <table cellpadding="12" cellspacing="0" border="0" width="100%" bgcolor="white" style="border:1px solid #e3e3e3;border-radius:4px">
                                                    <tbody>
                                                    <tr>
                                                        <td>
                                                            <table cellpadding="0" cellspacing="0" border="0" width="100%" bgcolor="white">
                                                                ...
                                                                <tr>
                                                                    <td width="84" align="left" valign="top">
                                                                        <a href="#" style="font-family:Helvetica,Arial,sans-serif;color:#333333" target="_blank">
                                                                            <img src="https://cdn.tictacsante.com/assets/images/doc/{{ Photo }}" onerror="this.src='https://cdn.tictacsante.com/assets/images/doc/Default.png'" width="70" height="70" style="width:70px;min-height:70px;border-radius:50%" class="CToWUd">
                                                                        </a>
                                                                    </td>
                                                                    <td>
                                                                        <table align="center" width="100%" cellspacing="0" cellpadding="0">
                                                                            ...
                                                                            <tr>
                                                                                <td>
                                                                                    <table width="49%" align="left" cellspacing="0" cellpadding="0">
                                                                                        <tbody>
                                                                                        <tr>
                                                                                            <td align="left" valign="top">
                                                                                                <a href="#">
                                                                                                </a><p style="margin:0;padding:0;color:#666666;font-size:17px;line-height:1.4em;font-family:Helvetica,Arial,sans-serif"><a href="#">
                                                                                                    </a><a href="#" style="font-family:Helvetica,Arial,sans-serif;color:#0086bf;text-decoration:none" target="_blank">
                                                                                                        <strong>{{ NomComplet_Praticien }}</strong>
                                                                                                    </a>
                                                                                                    <br>
                                                                                                    {{ NomSpecialite }}
                                                                                                </p>
                                                                                                ...
                                                                                                <table cellpadding="0" cellspacing="0" border="0" width="100%" style="width:100%!important">
                                                                                                    ...
                                                                                                    <tr>
                                                                                                        <td align="left" width="18">
                                                                                                            <img src="https://ci4.googleusercontent.com/proxy/hK81V2i7MaBecaYoW4fwIXyX9cVLavMCagk1ZcdzP5Wdwoo5_gC_XBUr5dbpfkzocDazzgi8R7EvjjCSCgoWA_BB8ApZLRO6c6eiW4yhHaQC6Yn1R-ygjO2MJPP6AoEA=s0-d-e1-ft#https://d1ovtcjitiy70m.cloudfront.net/vi-1/images/mails/single-star@2x.png" width="12" height="12" style="width:12px;min-height:12px" alt="" class="CToWUd">
                                                                                                        </td>
                                                                                                        <td align="left">
                                                                                                            <span style="color:#666666;font-size:14px;line-height:1.4em">
                                                                                                                <strong>
                                                                                                                    {{ avis.noteTotal }}/5
                                                                                    ...
                                                                                    <table width="48%" align="right" cellspacing="0" cellpadding="0">
                                                                                        <tbody>
                                                                                        <tr>
                                                                                            <td align="right" valign="top">
                                                                                                ...
                                                                                                {% if FixePraticien %}
                                                                                                    <img src="http://cdn.tictacsante.com/assets/img/phone-icon-neutral-32x48.png.png" width="16" height="24" alt=" " style="vertical-align:middle" align="middle" class="CToWUd">

                                                                                                    <strong style="font-family:Helvetica,Arial,sans-serif;color:#555555">
                                                                                                        <a href="tel:{{ FixePraticien }}" target="_blank">{{ FixePraticien }}</a>
                                                                                                    </strong>
                                                                                                {% endif %}
                                                                                                <table width="100%" cellpadding="0" cellspacing="0" border="0">
                                                                                                    <tbody>
                                                                                               ...
                                                                                               <!-- <a href="#" style="font-family:Helvetica,Arial,sans-serif;color:rgb(45, 150, 151);;text-decoration:underline" target="_blank">
                                        ...
                                        <tr>
                                            <td>
                                                ...
                                                <table align="left" bgcolor="#FFFFFF" width="100%" cellspacing="0" cellpadding="0" border="0" style="width:100%!important;background-color:#ffffff;color:#666666;border:1px solid #dddddd;font-family:Helvetica,arial,sans-serif;text-align:left;border-radius:3px">
                                                                                ...
                                                                                <td align="left">
                                                                                    <p style="margin:0;font-size:12px;color:#adafaf;font-weight:400">
                                                                                                  <span style="font-size:14px;line-height:14px;color:#333333">
                                                                                                    {{ dayName }} {{ DateRdv|date('d') }} {{ monthName }} {{ DateRdv|date('Y') }} à {{ DateRdv|date('H:i') }}
                                                                                            </span>
                                                                                    </p>
                                                                                </td>
                                                                            </tr>
                                                    ...
                                                    <tr>
                                                        <td align="center" bgcolor="#F9F9F9" style="padding:24px;text-align:center;background-color:#f9f9f9;border-top:1px solid #dddddd">

                                                            <table align="center" width="100%" cellpadding="0" cellspacing="0" border="0" style="width:100%!important">
                                                                <tbody>
                                                                <tr>
                                                                    <td align="center" valign="middle">
                                                                        <table border="0" cellpadding="0" cellspacing="0" style="font-family:arial,helvetica,sans-serif;background:#0086bf;border-radius:3px;border-collapse:separate;border:1px solid #0086bf;width:60%">
                                                                            <tbody>
                                                                            <tr>
                                                                                <td align="center" valign="middle" style="font-size:160%">
                                                                                    <a href="{{ UrlDashbord }}" style="display:block;padding:10px;color:#ffffff;text-decoration:none" target="_blank" data-saferedirecturl="#">
                                                                                        Mes rendez-vous</a>
                                                                                </td>
                                                                            </tr>
                                                                            </tbody>
                ...
                <p style="margin:0;margin-top:20px;text-align:center;font-family:sans-serif;color:#5f5f5f;font-size:13px;font-weight:100">
                    TicTacSanté © 2014/{{ "now"|date("Y") }} - Tous droits réservés.
                </p>
            </div>
        </div>
    </div>
