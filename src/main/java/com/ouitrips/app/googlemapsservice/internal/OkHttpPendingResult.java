...
import com.ouitrips.app.googlemapsservice.GeolocationApi;
import com.ouitrips.app.googlemapsservice.ImageResult;
import com.ouitrips.app.googlemapsservice.PendingResult;
...
import com.ouitrips.app.googlemapsservice.model.AddressComponentType;
import com.ouitrips.app.googlemapsservice.model.AddressType;
import com.ouitrips.app.googlemapsservice.model.Distance;
import com.ouitrips.app.googlemapsservice.model.Duration;
import com.ouitrips.app.googlemapsservice.model.Fare;
import com.ouitrips.app.googlemapsservice.model.LatLng;
import com.ouitrips.app.googlemapsservice.model.LocationType;
import com.ouitrips.app.googlemapsservice.model.OpeningHours.Period.OpenClose.DayOfWeek;
import com.ouitrips.app.googlemapsservice.model.PlaceDetails.Review.AspectRating.RatingType;
import com.ouitrips.app.googlemapsservice.model.PriceLevel;
import com.ouitrips.app.googlemapsservice.model.TravelMode;
import com.ouitrips.app.googlemapsservice.model.VehicleType;
...
public class OkHttpPendingResult<T, R extends ApiResponse<T>>
  ...
  public T await() throws ApiException, IOException, InterruptedException {
    ...
    if (retryCounter > 0) {
      // 0.5 * (1.5 ^ impl) represents an increased sleep time of 1.5x per iteration,
      // starting at 0.5s when impl = 0. The retryCounter will be 1 for the 1st retry,
      // so subtract 1 here.
      double delaySecs = 0.5 * Math.pow(1.5, retryCounter - 1);
      double jitter = secureRandom.nextDouble() - 0.5; // value between -0.5 and 0.5
      // Generate a jitter value between -delaySecs / 2 and +delaySecs / 2
      long delayMillis = (long) (delaySecs * (jitter + 1) * 1000);
