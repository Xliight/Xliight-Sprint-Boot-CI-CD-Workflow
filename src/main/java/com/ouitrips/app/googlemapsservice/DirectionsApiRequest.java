...
public class DirectionsApiRequest
  ...
  protected void validateRequest() {
    if (!params().containsKey(ORIGIN_PARAM)) {
      throw new IllegalArgumentException("Request must contain 'origin'");
    }
    if (!params().containsKey(DESTINATION_PARAM)) {
    ...
    if (params().containsKey(TRAFFIC_MODEL_PARAM) && !params().containsKey(DEPARTURE_TIME_PARAM)) {
      throw new IllegalArgumentException(
  ...
  public DirectionsApiRequest origin(String origin) {
    return param(ORIGIN_PARAM, origin);
  }
  ...
  public DirectionsApiRequest destination(String destination) {
    return param(DESTINATION_PARAM, destination);
  }
  ...
  public DirectionsApiRequest originPlaceId(String originPlaceId) {
    return param(ORIGIN_PARAM, prefixPlaceId(originPlaceId));
  }
  ...
  public DirectionsApiRequest destinationPlaceId(String destinationPlaceId) {
    return param(DESTINATION_PARAM, prefixPlaceId(destinationPlaceId));
  }
  ...
  public DirectionsApiRequest arrivalTime(Instant time) {
    return param(ARRIVAL_TIME_PARAM, Long.toString(time.toEpochMilli() / 1000L));
  }
  ...
  public DirectionsApiRequest departureTime(Instant time) {
    return param(DEPARTURE_TIME_PARAM, Long.toString(time.toEpochMilli() / 1000L));
  }
  ...
  public DirectionsApiRequest departureTimeNow() {
    return param(DEPARTURE_TIME_PARAM, "now");
  }
