...
public class StaticMapsRequest
  ...
  protected void validateRequest() {
    if (!((params().containsKey(PARAM_CENTER) && params().containsKey("zoom"))
  ...
  public StaticMapsRequest center(LatLng location) {
    return param(PARAM_CENTER, location);
  }
   ...
   * coverage area and level of detail (impl.e. the contents of the map doesn't change).
   *
