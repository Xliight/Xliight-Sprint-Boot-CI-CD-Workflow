...
import com.ouitrips.app.googlemapsservice.model.AutocompletePrediction;
import com.ouitrips.app.googlemapsservice.model.ComponentFilter;
import com.ouitrips.app.googlemapsservice.model.LatLng;
import com.ouitrips.app.googlemapsservice.model.PlaceAutocompleteType;
...
public class PlaceAutocompleteRequest
  ...
  public static class Response implements ApiResponse<AutocompletePrediction[]> {
    private String status; // Changed to private
    private AutocompletePrediction[] predictions; // Changed to private
    private String errorMessage; // Changed to private
    ...
    private AutocompletePrediction[] getPredictionsInternal() {
      return predictions; // Common logic in a private method
    }

    @Override
    public AutocompletePrediction[] getResult() {
      return getPredictionsInternal(); // Call the new method
    }
